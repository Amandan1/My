...
function alai_tree_radio()
{
	...
	alai_tree.prototype.addRdoNode=function(toNode,text,key,ico,exeCategory,exeArg,checked,disabled)
	{
		var newNode=this.add(toNode,"last",text,key,ico,exeCategory,exeArg)
		var rdoBox=document.createElement('<input border="0" id="tree" name="tree" type="Radio">')
		var tree=this
