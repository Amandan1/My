...
public class ReadMessageFromServerThread implements Runnable  {
	    ...
	    public ReadMessageFromServerThread(ServerClientConnectionStream userCS,
				...
				JList<String> currentOnlineUserList, MyMap isOnlineMap,
				MyMap isOpenMap) {
			// TODO Auto-generated constructor stub
		}

		public void ReadMessageFromClientThread(ClientToClientConnectionStream userDataCS, JTextArea chatTextArea,
