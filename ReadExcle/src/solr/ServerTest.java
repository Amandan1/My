...
public class ServerTest {
	 ...
	 //指定solr服务器的地址  
    private final static String SOLR_URL = "http://localhost:8080/solr/index.html#/new_core/";  
    ...
    * @throws SolrServerException 
    ...
    public void addDoc() throws SolrServerException, IOException{
       //构造一篇文档  
        ...
        document.addField("createdatetime", "1");  
        document.addField("updatedatetime", "1");  
        document.addField("url", "1");  
        document.addField("pic", "1");  
        document.addField("name", "1");  
        document.addField("title", "1");  
        document.addField("delflag", "1");  
        document.addField("num", "1");  
        document.addField("fairType", "1");  
...
*/
    public static void main(String[] args) throws Exception {
    	ServerTest solr = new ServerTest();
