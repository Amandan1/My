...
public class ResourceAction extends BaseAction<TResource> {
	private static final long serialVersionUID = 5656172525286749885L;
	 ...
	 * 获得角色的资源列表
	 */
	public void nsc_getRoleResources() {
		HqlFilter hqlFilter = new HqlFilter(getRequest());
	 ...
	 * 获得机构的资源列表
	 */
	public void nsc_getOrganizationResources() {
		HqlFilter hqlFilter = new HqlFilter(getRequest());
	 ...
	 * 获得资源树
	 */
	public void nsc_getResourcesTree() {
		treeGrid();
	}
