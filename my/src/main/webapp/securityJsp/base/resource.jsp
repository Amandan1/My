...
<script type="text/javascript">
	...
	var addFun = function() {
		var dialog = parent.myhope.modalDialog({
			title : '添加资源信息',
			url : myhope.contextPath + '/securityJsp/base/resourceForm.jsp',
			buttons : [ {
				text : '添加',
				handler : function() {
	...
	var showFun = function(id) {
		var dialog = parent.myhope.modalDialog({
			title : '查看资源信息',
			url : myhope.contextPath + '/securityJsp/base/resourceForm.jsp?id=' + id
		});
	};
	...
	var removeFun = function(id) {
		parent.$.messager.confirm('询问', '您确定要删除此记录？', function(r) {
			if (r) {
				$.post(myhope.contextPath + '/base/resource!delete.myhope', {
					id : id
				}, function() {
	...
	$(function() {
		grid = $('#grid').treegrid({
			title : '',
			url : myhope.contextPath + '/base/resource!treeGrid.myhope',
			idField : 'id',
			treeField : 'name',
			parentField : 'pid',
			rownumbers : true,
...
<body class="easyui-layout" data-options="fit:true,border:false">
	<div id="toolbar" style="display: none;">
		<table>
			<tr>
				<%if (securityUtil.havePermission("/base/resource!save")) {%>
