...
$.extend($.fn.dialog.defaults, myhope.onMove);
$.extend($.fn.window.defaults, myhope.onMove);
$.extend($.fn.panel.defaults, myhope.onMove);
...
$.extend($.fn.datagrid.defaults, myhope.onLoadError);
$.extend($.fn.treegrid.defaults, myhope.onLoadError);
$.extend($.fn.tree.defaults, myhope.onLoadError);
$.extend($.fn.combogrid.defaults, myhope.onLoadError);
$.extend($.fn.combobox.defaults, myhope.onLoadError);
$.extend($.fn.form.defaults, myhope.onLoadError);
...
$.extend($.fn.combotree.defaults, myhope.loadFilter);
$.extend($.fn.tree.defaults, myhope.loadFilter);
 ...
 * 
 */
myhope.modalDialog = function(options) {
	var opts = $.extend({
		title : '&nbsp;',
		width : 640,
		height : 480,
 ...
 * @param themeName
 */
myhope.changeTheme = function(themeName) {
	...
	myhope.cookie('easyuiTheme', themeName, {
		expires : 7
	});
};
 ...
 * @requires jQuery,EasyUI
 */
myhope.progressBar = function(options) {
