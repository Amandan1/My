...
<script type="text/javascript" charset="utf-8">
    ...
    var myChart = echarts.init(document.getElementById('main_p2'));
    var option = {
        title: {
            text: ''
        },
    ...
    function loadData(option) {
        $.ajax({
            type : 'post',	//传输类型
            async : false,	//同步执行
            url : myhope.contextPath + '/portal/portal!nsc_getMemberSignCount.myhope',
            data : {},
...
<div id="main_p2" style="width: 800px;height:300px;">
</div>