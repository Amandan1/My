...
<script type="text/javascript" charset="utf-8">
	var lockWindowFun = function() {
		$.post(myhope.contextPath + '/base/user!nssnsc_logout.myhope', function(result) {
...
<div class="logo" style="height: 67px;width:230px;><!--<div style="height: 70px;width:120px;float: left;"/><img id="north_userPhoto" style="height: 70px;"/>--></div>
